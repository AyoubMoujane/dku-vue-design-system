...
<template>
  <RangeCalendarHeader :class="cn('relative flex w-full items-center justify-between pt-1 bg-[#214AB5] text-white rounded-t-md', props.class)" v-bind="forwardedProps">
    <slot />
  </RangeCalendarHeader>
</template>
